    ...
    pub fn new(
        ...
        let capture_string =
            pipeline_head(camera_path, camera_dimensions.0, camera_dimensions.1, 30)
                ...
                + "raw. ! queue  ! videoconvert ! videobalance brightness=-1.0  ! appsink "
...
fn pipeline_head(device_name: &str, width: u32, height: u32, framerate: u32) -> String {
    ...
    return format!("v4l2src device={device_name} exposure=0 ! image/jpeg, width={width}, height={height}, framerate={framerate}/1");
}
